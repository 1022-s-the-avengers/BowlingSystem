...
public class MemberInfoGenerator {
    public void nameGenerate(ArrayList<Member> memberList) {
        ...
        for (int i = 1; i <= 60; ++i) {
            memberList.get(i).setName(
                    familyName.get(RandIntegerGenerator.uniformRand(0, 60)) +
                    firstName.get(RandIntegerGenerator.uniformRand(0, 60)));
        }
    }
    public void provinceGenerate(ArrayList<Member> memberList) {
        ...
        for (int i = 1; i <= 60; ++i) {
            memberList.get(i).setProvince(province.get(RandIntegerGenerator.uniformRand(0, 60)));
        }
    }
}
